...
function Signup() {
  ...
  return (
    ...
    >
      <h2 className="text-4xl font-bold text-center text-[#5A189A] mb-4">
        Create Account
      </h2>
      <p className="text-center text-[#3C096C] mb-6 text-sm font-medium">
        Track your todo's with us
      </p>
      ...
      {success && (
        <div className="mb-4 text-center text-green-600 font-semibold text-sm">
